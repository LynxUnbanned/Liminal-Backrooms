...
AI_MODELS = {
    ...
    "Cerebras - GLM 4.6": "zai-glm-4.6",

    # OpenRouter
    "OpenRouter - Grok 4.1 Fast": "x-ai/grok-4.1-fast:free",
    "OpenRouter - DeepSeek R1": "tngtech/deepseek-r1t2-chimera:free",
    "OpenRouter - GLM 4.5 Air": "z-ai/glm-4.5-air:free",
    "OpenRouter - Qwen 3 Coder 480B": "qwen/qwen3-coder:free",
    "OpenRouter - Venice": "cognitivecomputations/dolphin-mistral-24b-venice-edition:free",
}
...
!add_ai "Model Name" "optional persona" - Invite another AI to join (max 5 in room)
  Available: Gemini 2.5 Pro, Gemini 2.5 Flash, Gemini 2.5 Flash Lite, Groq - GPT OSS 120B, Groq - GPT OSS 20B, Groq - Kimi K2, Cerebras - GPT OSS 120B, Cerebras - Qwen 3 235B, Cerebras - GLM 4.6, OpenRouter - Grok 4.1 Fast, OpenRouter - DeepSeek R1, OpenRouter - GLM 4.5 Air, OpenRouter - Qwen 3 Coder 480B, OpenRouter - Venice
